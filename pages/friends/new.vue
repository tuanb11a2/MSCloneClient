      ...
      >
        <div class="flex-1 px-2 py-10 sm:py-0 sm:px-0">
          <div class="md:flex md:justify-between items-center">
            <h3 class="text-3xl">Gợi ý kết bạn mới</h3>
              ...
              >
                ...
                <div class="my-auto font-bold ml-5">
                  <span
                    ...
                    class="block rounded-full text-sm ml-6 text-center cursor-pointer bg-blue-500 hover:bg-blue-700 text-white w-10 h-10 p-2"
                  >
                ...
                <ConfirmModal
                  ...
                  :content="`Bạn có chắc muốn gửi lời mới kết bạn tới ${friend.name}?`"
                  :id="`modal-${friend.id}`"
