          ...
          <div class="">
            <div class="mt-3 sm:mt-0 sm:ml-4 sm:text-left">
              ...
              <div class="mt-5">
                ...
                >
                <select
                  v-model="$parent.newTodo.groupId"
                  class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                >
              ...
              <div class="mt-5">
                ...
                <select
                  v-model="$parent.newTodo.type"
                  class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                >
                  <option :value="$parent.newTodo.type" disabled>
                    {{ $parent.newTodo.typeTitle }}
                  </option>
                </select>
                <div class="mt-5">
                  <label
                  ...
                  >
                  <select
                    v-model="$parent.newTodo.priority"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                  >
              ...
              <div class="mt-5">
                ...
                <input
                  ...
                  class="input"
                  :min="today"
                  v-model="$parent.newTodo.deadline"
                />
                <div
                  v-if="$parent.$v.newTodo.deadline.$error"
                  class="text-red-500 text-sm font-bold mt-2"
                >
